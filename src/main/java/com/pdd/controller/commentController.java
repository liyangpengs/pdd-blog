...
public class commentController {
	...
	@ResponseBody
	public JsonData addComment(@RequestParam(required=true)Integer nid,@RequestParam(required=true)String content){
	...
	@ResponseBody
	public JsonData reply(String ids,String content){
		JsonData json=new JsonData();
		try {
			content=xssUtils.xssFilter(content);
			User user=(User)SecurityUtils.getSubject().getPrincipal();
