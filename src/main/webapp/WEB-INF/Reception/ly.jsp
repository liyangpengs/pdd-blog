...
<meta name="keywords" content="pdd的留言板"/>
<meta name="description" content="pdd的留言板"/>
    ...
    <div class="content-wrap">
        ...
        <div class="comment">
        	<div class="comment-top">
        		<span>留言:</span>
        		<textarea rows="5"  class="comment-input" maxlength="100" cols="40" placeholder="留下你的最想说的话吧[最多100字]"></textarea>
        		<div class="publish-comment"><button id="publish-comment">发布留言</button></div>
        	</div>
        	<div class="comment-buttom">
        		<div class="comments">
        			<div class="comments-left">
        				<img alt="" src="/static/imgs/logo.jpg"></div><div class="comments-rigth">
        			<div class="comments-top"><font>pdd 	</font> ：<span class="glyphicon glyphicon-pushpin">未知地点</span></div>
        			<div class="comments-content">
        			<p>.......</p>
        			</div>
        			<div class="comments-publishTime">留言时间：2018-01-03 14:24:45</div></div>
        		</div>
			</div>
        </div>
</div>
