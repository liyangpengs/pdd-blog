	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main">
				<a href="#" class="logo">pdd养成计划后台管理</a>
				<!-- 显示/隐藏菜单 -->
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="../../static/imgs/face.jpg" class="layui-circle" width="35" height="35">
							<cite>超级管理员</cite>
						</a>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="../../static/imgs/face.jpg"></a>
			...
			<div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="../../view/admin/main"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p>copyright @2017-2019 pdd养成计划</p>
		</div>
	</div>
	<!-- 移动导航 -->
