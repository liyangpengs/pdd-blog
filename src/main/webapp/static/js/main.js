layui.config({
	...
	//用户数
	$.get("../../static/conf/usersList.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "../../static/conf/systemParameter.json",
			type : "get",
			dataType : "json",
